...
namespace SistemaEscolar
{
    ...
    public partial class FrmLogin : Form
    {
        ...
        public event Action<string, string> btnIngresarAction;
                ...
                else
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            sesion.Nivel = sesion.IniciarSesion(txtUsuario.Text, txtContra.Text);
                            if (sesion.Nivel == 1)
                            {
        ...
        */
        ...
        {
            btnIngresarAction?.Invoke(txtUsuario.Text, txtContra.Text);
